...
/**
 * ROLLBACK NOTE: This file was reverted to Step 1328 for stability.
 * LATEST UPDATE: Localized text, fixed scroll position, swapped image order, and centered layouts.
 */

function FadeInSection({ children, animation = 'fade-up', delay = 0 }) {
        ...
        const base = {
            ...
            transform: isVisible ? 'none' :
                animation === 'fade-up' ? 'translateY(40px)' :
                    animation === 'slide-up' ? 'translateY(100px)' :
                        animation === 'scale' ? 'scale(0.98)' : 'none'
        };
        return base;
    };
...
export default function About() {
    ...
    const contentBoxStyle = {
        ...
        textAlign: 'center',
        zIndex: 2,
        margin: '0 auto' // Ensure content box is centered
    };
    ...
    const imageContainerStyle = {
        width: '100%',
        maxWidth: '500px',
        margin: '3rem auto 0', // Centered alignment fix
        borderRadius: '2rem',
        overflow: 'hidden',
                ...
                <div style={contentBoxStyle}>
                    ...
                    <FadeInSection animation="fade-up" delay={0.2}>
                        <div style={imageContainerStyle}>
                            <img src="/assets/about/about-hero-wall.jpg" alt="Memotiles Gallery Wall" style={{ width: '100%', display: 'block' }} />
                        </div>
                    </FadeInSection>
                </div>
            </section>
                ...
                <div style={contentBoxStyle}>
                    ...
                    <FadeInSection animation="slide-up" delay={0.2}>
                        <div style={{ ...imageContainerStyle, maxWidth: '600px' }}>
                            <img src="/assets/about/gallery-new.jpg" alt="Gallery Layout" style={{ width: '100%', display: 'block' }} />
                        </div>
                    </FadeInSection>
                </div>
            </section>
                ...
                <div style={contentBoxStyle}>
                    ...
                    <FadeInSection animation="scale" delay={0.3}>
                        <div style={{ ...imageContainerStyle, maxWidth: '450px', borderRadius: '1.5rem' }}>
                            <img src="/assets/about/hero.png" alt="Memotiles Interior" style={{ width: '100%', display: 'block' }} />
                        </div>
                    </FadeInSection>
                </div>
            </section>
